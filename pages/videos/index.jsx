...
const Videos = () => {
    ...
    return (
        <div  sx={{ minHeight: '100vh', textAlign: 'center', display: 'flex', flexFlow: "column wrap", alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: '7rem', marginTop: '5rem'} }>
